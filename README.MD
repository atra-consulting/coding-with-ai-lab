...
> **Windows:** `start.bat` existiert, ist aber aktuell noch nicht auf den neuen Tech-Stack migriert. Bitte `start.sh` via WSL oder Git Bash verwenden.
...
├── start.sh            Startskript (macOS/Linux/WSL)
