...
- **Admin-Tools** — Agent-Aufgaben- und Cron-Job-Dashboards (nur ADMIN)
- **Dark Mode** — Umschaltbar in der Navbar, in `localStorage` gespeichert
...
| **Datenbank** | SQLite (file-based, via `@libsql/client`) |
