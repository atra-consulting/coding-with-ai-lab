...
// KI-Prozess mit Feedback (11 steps). Sum: work 120 + wait 325 = 445.
const SEMI_WORKS = [0,5,10,11,5,10,11,5,11,30,22];
const SEMI_WAITS = [5,60,5,60,60,5,60,5,60,5];

// KI-Prozess vollautomatisch (2 steps). Sum: work 60 + wait 5 = 65.
const AUTO_WORKS = [0,60];
const AUTO_WAITS = [5];
