...
- Backend: Spring Boot 3.5.3 (Java 21) with entity pattern (Entity -> DTO -> Mapper -> Repository -> Service -> Controller)
- CIAM: Kotlin Spring Boot 3.5.3 for Identity & Access Management
